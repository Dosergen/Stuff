...
public Plugin myinfo =
{
	...
	version =       "1.2",
	url =           "https://github.com/Silenci0/SMAC/blob/master/addons/sourcemod/scripting/smac_eyetest.sp"
}
...
{
	if (GetEntPropEnt(caller, Prop_Send, "m_hGroundEntity") == 0)
	{
	...
	if (!IsClientInGame(caller) || GetClientTeam(caller) != 2 || type != Use_Toggle)
	{
		return Plugin_Continue;
	}
