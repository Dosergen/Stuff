...
int g_iTier2Index1[] = {3, 4, 5};
int g_iTier2Index2[] = {8, 9, 10, 11, 14, 15, 16};
int g_iTier1Index1[] = {1, 2};
int g_iTier1Index2[] = {6, 7, 13};
int g_iMagnumIndex = 12;
int g_iPistolIndex = 0;
		
ConVar g_hCvar_PluginEnable, g_hCvar_GunTypes, g_hCvar_AutoShotgunCount, g_hCvar_RifleCount, g_hCvar_Hunting_RifleCount, g_hCvar_PistolCount, g_hCvar_PumpshotgunCount,
       g_hCvar_SmgCount, g_hCvar_OtherGunsCount, g_hCvar_MaxBotHalt, g_hCvar_MaxClientsLoading, g_hSbStopCvar;
